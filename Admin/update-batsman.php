...
if (isset($_GET['player_id'])) {
    ...
    if (isset($_POST['update_batsman'])) {
        ...
        $sql = "REPLACE INTO batsman (player_id, order_no, batting_style) VALUES ($player_id, '$order_no', '$batting_style')";
...
<body>
    <h1 class="text-center text-3xl font-extrabold p-6">Update Player as Batsman</h1>
    <form method="POST" class="max-w-lg mx-auto p-6 shadow-lg bg-white rounded-lg">
        ...
        <button type="submit" name="update_batsman" class="btn btn-primary w-full">Update Batsman</button>
    </form>
</body>
