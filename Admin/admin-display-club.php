...
<head>
    ...
    <title>Admin Club List</title>
</head>

<body>
    <h1 class="text-center text-3xl font-extrabold p-6">Club List</h1>
            ...
            <tbody>
                ...
                if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        $history = $row['history'];
                        $phone_numbers = $row['phone_numbers'] ?? 'N/A';
                        $emails = $row['emails'] ?? 'N/A';
                        ...
                        echo '<tr>
                            ...
                            <td class="text-center"> 
                                <button class="btn btn-outline btn-success">
                                    <a href="update-club.php?updateid=' . $club_id . '">Update</a>
                                </button>
                            </td>
                        </tr>';
                    }
