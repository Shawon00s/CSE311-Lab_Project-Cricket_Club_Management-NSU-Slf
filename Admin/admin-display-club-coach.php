                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td class="text-center"> 
                            <button class="btn btn-outline btn-success"><a href="update-club-coach.php?updateid=' . $row['coach_id'] . '">Update</a></button>
                            <button class="btn btn-outline btn-error"><a href="delete-club-coach.php?deleteid=' . $row['coach_id'] . '">Delete</a></button>
                        </td>
                    </tr>';
                    }
                } else {
