...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO player (player_name, date_of_birth, nationality) 
            VALUES ('$player_name', '$date_of_birth', '$nationality')";

    if (mysqli_query($conn, $sql)) {
        header('location:display-player.php');
    } else {
...
<body>
    ...
    <div>
        <h1 class="font-bold text-2xl text-center mt-5">Register Player</>
    </div>
    <form class="max-w-2xl mx-auto pt-6" action="add-player.php" method="POST">
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" id="floating_name"
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" " required name="player_name" />
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="date" id="floating_date"
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" " required name="date_of_birth" />
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" id="floating_nationality"
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" " required name="nationality" />
